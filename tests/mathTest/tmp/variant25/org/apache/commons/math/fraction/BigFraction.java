 ...
 * immutable.
 *
 * @version $Revision: 885278 $ $Date: 2009-11-30 05:47:51 +0800 (월, 30 11월 2009) $
 * @since 2.0
 */
    ...
    public BigFraction(BigInteger num, BigInteger den) {
		{
			if (num == null) {
				throw MathRuntimeException
						.createNullPointerException("numerator is null");
			}
			if (den == null) {
				throw MathRuntimeException
						.createNullPointerException("denominator is null");
			}
			if (BigInteger.ZERO.equals(den)) {
				throw MathRuntimeException
						.createArithmeticException(FORBIDDEN_ZERO_DENOMINATOR);
			}
		...
		{
			throw MathRuntimeException
					.createIllegalArgumentException("cannot convert NaN value");
		}
	}
