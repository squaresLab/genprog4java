...
public class NSGAIIDataStorer implements Serializable {
	...
	public ArrayList<ArrayList<Pair<Integer, Double>>> nsgaiiFitnesses = new ArrayList<>(); //left elem of Pair is domination rank, right elem of Pair is crowding distance
	public ArrayList<ArrayList<Map<Class<?>, Double>>> objectiveValues = new ArrayList<>(); //maps Objective class -> Objective value
